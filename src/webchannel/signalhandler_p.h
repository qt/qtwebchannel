...
private:
    ...
    void setupSignalArgumentTypes(const QMetaObject *metaObject, const QMetaMethod &signal, const QObject *object = 0);
...
void SignalHandler<Receiver>::connectTo(const QObject *object, const int signalIndex)
{
    ...
    setupSignalArgumentTypes(metaObject, signal, object);
}

template<class Receiver>
void SignalHandler<Receiver>::setupSignalArgumentTypes(const QMetaObject *metaObject, const QMetaMethod &signal, const QObject *object)
{
