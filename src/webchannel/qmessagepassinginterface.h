...
/*!
    ...
    to QWebChannel::connectTo(). Currently, this interface is implemented by the QML WebSocket and
    WebView.experimental objects. Pure C++ applications will have to provide custom wrappers.
 */
